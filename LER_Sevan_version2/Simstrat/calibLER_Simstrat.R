...
save(resMCMC, file = 'cal_LHC_5000_Simstrat.RData')
...
print(best_p)
# save(resMCMC, file = 'cal_MCMC_5000_Simstrat.RData')
# 
# best_par <- setNames(lapply(model, function(m)resMCMC[[m]]$bestpar), model)
# print(best_par)
# 
# pairs(resMCMC$Simstrat)
# plot(resMCMC$Simstrat)
# summary(resMCMC$Simstrat)
